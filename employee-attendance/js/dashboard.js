    ...
    async function showFaceCaptureModal(action) {
        ...
        try {
            ...
            if (result.success) {
                ...
                updateFaceCaptureStatus('ready', 'Position your face in the camera and click Proceed');
                
                // Auto-capture after a short delay (similar to login page)
                setTimeout(() => {
    ...
    async function handleFaceCapture() {
        ...
        try {
            ...
            if (result.success) {
                ...
                updateFaceCaptureStatus('error', result.error || 'Failed to capture face. Please try again.');
