...
document.addEventListener('DOMContentLoaded', function() {
    ...
    proceedBtn.addEventListener('click', (e) => {
        ...
        // Check if this is after face login (user is authenticated) or during face login
        if (authenticatedUser && capturedFaceData && authManager.currentUser) {
            ...
            // User needs to complete face login first
            console.log('Face login required - calling handleFaceLogin');
            handleFaceLogin();
        }
    });
    ...
    proceedBtn.onclick = (e) => {
        ...
        if (authenticatedUser && capturedFaceData && authManager.currentUser) {
            ...
            // User needs to complete face login first
            console.log('Face login required - calling handleFaceLogin (onclick)');
            handleFaceLogin();
        }
    };
    ...
    async function handlePasswordLogin() {
        ...
        try {
            ...
            if (result.success) {
                ...
                if (!cameraReady) {
                    showError('Camera initialization failed. Please refresh and try again.');
                    return;
                }
